...
const PLANS = {
  ...
  custom: {
    name: "Custom",
    price: 149.00,
    priceId: process.env.STRIPE_PRICE_ENTERPRISE || process.env.STRIPE_PRICE_CUSTOM,
    isCustom: false, // Now has a fixed price or can be custom
    features: [
      "Tout du plan Pro",
      "Accès API & Webhooks",
      "Marque blanche",
