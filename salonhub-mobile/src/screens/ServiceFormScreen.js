...
const ServiceFormScreen = ({ navigation, route }) => {
  ...
  const handleSubmit = async () => {
    ...
    setSubmitting(true);
    try {
      // Upload image if one was selected and it's a local URI
      let uploadedImageUrl = null;
      if (imageUri && imageUri.startsWith("file://")) {
        try {
          uploadedImageUrl = await uploadImage(imageUri, "service-image");
        } catch (uploadError) {
          console.error("Erreur upload image service:", uploadError);
          Alert.alert(
            "Avertissement",
            "L'image n'a pas pu être uploadée, mais le service sera sauvegardé sans image"
          );
        }
      }
      ...
      const serviceData = {
        ...
        image_url:
          uploadedImageUrl ||
          (imageUri && !imageUri.startsWith("file://") ? imageUri : null),
      };
      ...
      const errorMessage =
        ...
        "Impossible de sauvegarder le service";
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          {imageUri ? (
            <View style={styles.imagePreviewContainer}>
              <Image
                source={{ uri: API_URL.replace("/api", "") + imageUri }}
              ...
              <View style={styles.imageActions}>
                ...
                <TouchableOpacity
                  style={[
                    ...
                    styles.imageActionButtonDanger,
                  ]}
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.helperText}>
            Les services inactifs ne seront pas visibles dans les listes de
            réservation
          </Text>
        </View>
