...
const ProfileScreen = ({ navigation }) => {
  ...
  const loadProfile = async () => {
    ...
    if (user) {
      ...
      setProfileImageUri(user.profile_image || null);
    }
    ...
    try {
      ...
      if (response.data.success && response.data.data) {
        ...
        setProfileImageUri(response.data.data.profile_image || null);
      ...
      // If API fails, keep using data from context
  ...
  const handleUpdateProfile = async () => {
    ...
    try {
      ...
      const errorMessage = error.response?.data?.error || error.response?.data?.message || 'Impossible de mettre à jour le profil';
  ...
  const handleChangePassword = async () => {
    ...
    try {
      ...
      const errorMessage = error.response?.data?.error || error.response?.data?.message || 'Impossible de changer le mot de passe';
      Alert.alert('Erreur', errorMessage);
    } finally {
      setSubmitting(false);
    }
        ...
        <View style={styles.section}>
          ...
          {showPasswordSection && (
            <View style={styles.passwordSection}>
              ...
              <TouchableOpacity
                style={[styles.submitButton, styles.submitButtonSecondary, submitting && styles.submitButtonDisabled]}
              ...
              >
                {submitting && showPasswordSection ? (
                  ...
                  <>
                    ...
                    <Text style={[styles.submitButtonText, styles.submitButtonTextSecondary]}>
